...
public class TypeDeclaration extends Declaration {
  ...
  static {
    Class[] params = { TypeDeclaration.class, OutputStream.class };
    try {
  ...
  public TypeDeclaration( Specifier spec ) {
  ...
  public TypeDeclaration( Specifier spec, List<Declarator> names ) {
  ...
  public static void defaultPrint( TypeDeclaration obj, OutputStream stream ) {

    PrintStream p = new PrintStream( stream );

    obj.spec.print( stream );
    p.print( " " );
