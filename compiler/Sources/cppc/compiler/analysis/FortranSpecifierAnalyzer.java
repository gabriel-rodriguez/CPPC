...
public class FortranSpecifierAnalyzer extends SpecifierAnalyzer {

    FortranSpecifierAnalyzer() {}

    protected Set<Identifier> analyzeSpecifier( FortranArraySpecifier spec ) {
      Set<Identifier> ret = ExpressionAnalyzer.analyzeExpression(
        currentStatement, spec.getLowerBound() );
